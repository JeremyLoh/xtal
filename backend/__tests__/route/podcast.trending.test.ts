...
describe("GET /api/podcast/trending", () => {
  ...
  describe("given one category", () => {
    test("should respond with podcasts in given category", async () => {
      ...
      sortExpectedPodcastsByScore(expectedPodcasts)
...
function getDefaultTrendingPodcasts() {
  const data = [
    ...
    },
    {
      ...
      description:
        '<p>Introducing <strong>Bank on it: A Life in Sports with Noah Banks</strong>, the networking podcast where Noah Banks connects with industry experts across the world of sports. Each episode dives deep into engaging conversations with athletes, executives, and innovators, providing listeners with insider insights and invaluable career advice. Whether you\'re looking to grow your network or just love hearing from the best in the business, this podcast gives you front-row access to the stories and strategies shaping the future of sports.</p><p>Follow Noah on <a rel="noopener" href="https://twitter.com/Banx_Leaf">Twitter @Banx_Leaf</a> and never miss an episode. Join the conversation and expand your network today!</p>',
      author: "Noah Banks",
      image:
  ...
  sortExpectedPodcastsByScore(data)
