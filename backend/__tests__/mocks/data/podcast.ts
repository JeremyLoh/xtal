...
export const PODCAST_TRENDING_DEFAULT_TEN_ENTRIES: PodcastIndexTrendingPodcastResponse =
  {
    status: "true",
    feeds: [
      {
...
export const PODCAST_TRENDING_TEN_ARTS_PODCASTS: PodcastIndexTrendingPodcastResponse =
  {
    status: "true",
    feeds: [
      {
