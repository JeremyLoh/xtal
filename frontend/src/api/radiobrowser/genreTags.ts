...
export const genres: Array<GenreInformation> = [
  ...
  { genre: "Club", searchTag: "club", approxStationCount: 113 },
  ...
  { genre: "Kids", searchTag: "kids", approxStationCount: 32 },
  ...
  { genre: "Movie", searchTag: "movie", approxStationCount: 34 },
  ...
  { genre: "Talk", searchTag: "talk", approxStationCount: 1106 },
